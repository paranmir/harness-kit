...
`docs/planning-protocol/task-classification.md`. The full
...
`docs/law/USER_INTENT_ALIGNMENT.md` §Application Scope mode 2 (non-plan-
...
`docs/law/USER_INTENT_ALIGNMENT.md`. Add others as applicable —
`docs/law/INPUT_OUTPUT_CONTRACT.md`, `docs/law/ORACLE_AND_JUDGMENT.md`,
`docs/law/CODE_AUTHORSHIP_AND_STEWARDSHIP_RULES.md`, etc.)
```
