...
persona review per `agentlaw_docs/law/PLANNING_AND_REVIEW_RULES.md` § Required Planning
...
`agentlaw_docs/planning-protocol/lightweight-plan-template.md`. The lightweight plan
records the operational contract per `agentlaw_docs/law/USER_INTENT_ALIGNMENT.md`
