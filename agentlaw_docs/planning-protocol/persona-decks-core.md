...
`agentlaw_docs/law/PLANNING_AND_REVIEW_RULES.md` § Required Planning Workflow. The
...
- The persona enforces `agentlaw_docs/law/PLANNING_AND_REVIEW_RULES.md` § Code-Fact Claim Verification Trace at plan-review time.
...
recorded in `agentlaw_docs/planning-protocol/persona-section-map.md`. When a plan
